...
<body class="min-vh-100 d-flex flex-column position-relative">
    ...
    <hr>
    <div class="container d-flex justify-content-center shadow mb-5 border rounded mt-3" style="height: 600px">
        <div class="h-100 w-25 d-flex flex-column justify-content-between align-items-center rounded-2">
            <div class="list-group p-2 w-100">
                ...
                <a href="{{ route('change-password') }}" class="list-group-item bg-warning">{{ __('account.change-password') }}</a>
        ...
        <div class="w-75 p-3 rounded-2">
            <h2>{{ __('account.change-password') }}</h2>
            <form action="{{ route('update-password') }}" method="POST" class="d-flex flex-column">
                ...
                <div class="form-group d-flex align-items-center p-2 w-100 justify-content-between">
                    <label for="old_password" class="form-label text-dark me-3 w-50">{{ __('account.old-password') }}</label>
                ...
                <div class="form-group d-flex align-items-center p-2 w-100 justify-content-between">
                    <label for="new_password" class="form-label text-dark me-3 w-50">{{ __('account.new-password') }}</label>
                ...
                <div class="form-group d-flex align-items-center p-2 w-100 justify-content-between">
                    <label for="new_password_confirmation" class="form-label text-dark me-3 w-50">{{ __('account.confirm-password') }}</label>
                ...
                <button type="submit" class="btn btn-warning mt-3 w-25">{{ __('account.change-password') }}</button>
            </form>
        </div>
    </div>
